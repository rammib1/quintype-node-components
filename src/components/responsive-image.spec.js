...
describe("ResponsiveImage", () => {
  ...
  //   const { container } = render(
  //     <Provider store={createStore(x => x, { qt: { config: { 'cdn-image': "images.assettype.com", "image-format": "gumlet" } } })}>
  //       <ResponsiveImage
  //         slug="somepublisher/image.png"
  //         metadata={{ "width": 760, "height": 427, "focus-point": [306, 125] }}
  //         aspectRatio={[16, 9]}
  ...
  //   const image = container.firstChild;
  //   expect(image["data-src"]).toBe("http://images.assettype.com/somepublisher%2Fimage.png?rect=0%2C0%2C759%2C427");
  //   expect(image.src).toBe("data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=");
  //   // expect(image).toMatchSnapshot();
  // });
})
